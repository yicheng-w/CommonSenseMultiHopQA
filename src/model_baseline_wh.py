...
class GatedMultiBidafWithSelfAttnAndELMoCUDNN_MC(BaseModel):
    '''
    ...
    def build_graph(self):
        ...
        dec_hidden_sz = self.opt.hidden_size_encoder #self.opt.hidden_size_decoder
        ...
        # because this is multiple choice, we calculate the gneration
        # probability instead of actual tokens
    ...
    def encode(self, batch, is_train):
        ...
        encoded_answers_tgt, encoded_answers_tgt_len = encode_data(
                ...
                add_eos=True)
        assert encoded_answers_tgt.shape[1] == encoded_answers_inp.shape[1]
        ...
        assert max(encoded_answers_tgt_len) == max(encoded_answers_inp_len)
